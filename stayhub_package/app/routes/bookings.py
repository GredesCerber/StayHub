...
def new_booking_form(
    ...
    default_check_in = today_value.isoformat()
    default_check_out = (today_value + timedelta(days=1)).isoformat()
    return templates.TemplateResponse("bookings/form.html", {
        ...
        "min_check_in": default_check_in,
        "min_check_out": default_check_out
    })
...
def create_booking_form(
    ...
    try:
        ...
        guests = guest_service.get_all_guests()
        today_value = date.today()
        min_check_in = today_value.isoformat()
        min_check_out = (today_value + timedelta(days=1)).isoformat()
        if check_in_date:
            min_check_in = min(check_in_date, today_value).isoformat()
            min_check_out = max(check_in_date + timedelta(days=1), today_value + timedelta(days=1)).isoformat()
        return templates.TemplateResponse("bookings/form.html", {
            "request": request, 
            "booking": None, 
            "rooms": rooms, 
            "guests": guests,
            "error": str(e),
            "default_check_in": check_in_date.isoformat() if check_in_date else min_check_in,
            "default_check_out": check_out_date.isoformat() if check_out_date else min_check_out,
...
def edit_booking_form(
    ...
    today_value = date.today()
    min_check_in = today_value.isoformat()
    if booking.check_in_date and booking.check_in_date < today_value:
        min_check_in = booking.check_in_date.isoformat()
    min_check_out_date = (booking.check_in_date or today_value) + timedelta(days=1)
    min_check_out = min_check_out_date.isoformat()
    default_check_in = booking.check_in_date.isoformat() if booking.check_in_date else today_value.isoformat()
    default_check_out = booking.check_out_date.isoformat() if booking.check_out_date else min_check_out
    return templates.TemplateResponse("bookings/form.html", {
        "request": request, 
        "booking": booking, 
        "rooms": rooms, 
...
def update_booking_form(
    ...
    try:
        ...
        if booking.check_in_date and booking.check_in_date < today_value:
            min_check_in = booking.check_in_date.isoformat()
        min_check_out = ((booking.check_in_date or today_value) + timedelta(days=1)).isoformat()
        return templates.TemplateResponse("bookings/form.html", {
            "request": request, 
            "booking": booking, 
            "rooms": rooms, 
            ...
            "min_check_in": min_check_in,
            "min_check_out": min_check_out,
            "default_check_in": booking.check_in_date.isoformat() if booking.check_in_date else min_check_in,
            "default_check_out": booking.check_out_date.isoformat() if booking.check_out_date else min_check_out
        })
