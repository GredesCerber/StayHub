...
from app.schemas.room import RoomCreate, RoomUpdate, Room as RoomSchema, RoomFilter
...
def rooms_list(
    ...
    if room_type or is_avail is not None:
        rooms = service.search_rooms(room_type=room_type, is_available=is_avail)
    else:
